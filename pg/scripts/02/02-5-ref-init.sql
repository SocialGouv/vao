...
GRANT USAGE ON SCHEMA referentiel TO :"app_role";
...
GRANT ALL ON ALL TABLES IN SCHEMA referentiel TO :"app_role";
GRANT ALL ON ALL SEQUENCES IN SCHEMA referentiel TO :"app_role";
