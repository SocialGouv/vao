...
create table front.demande_sejour (
   ...
   responsable_sejour           JSONB                NOT NULL,
   hebergement                  JSONB                ,
   vacanciers                   JSONB                ,
   personnel                    JSONB                ,
   transport                    JSONB                ,
...
GRANT USAGE ON SCHEMA front TO :"app_role";

GRANT ALL ON ALL TABLES IN SCHEMA front TO :"app_role";
GRANT ALL ON ALL SEQUENCES IN SCHEMA front TO :"app_role";
