...
const appendContent = (alerts: Rows, starter: string) => {
...
type CreateContentParams = { dsWithAlerts: Rows; dsWithoutAlerts: Rows };
...
export const sendEmails = async (rows: Rows, isBo: boolean) => {
