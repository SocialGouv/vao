...
useHead({
  title: "Demande d'agrément transmise | Vacances Adaptées Organisées",
  meta: [
    {
      name: "description",
      content: "Demande d'agrément transmise.",
    },
  ],
});
...
<style scoped>
.fr-icon--green {
  color: var(--dark-decisions-text-text-default-success, #27a658);
}
h1 {
  font-size: 32px;
  font-style: normal;
