          ...
          <div class="fr-fieldset__element fr-col-12">
            <div class="fr-input-group">
              <DsfrRadioButtonSet
                ...
                :inline="true"
                :error-message="
                  conservationMedicamentThermosensibleErrorMessage
                "
                @update:model-value="
                  onConservationMedicamentThermosensibleChange
                "
              />
            </div>
          </div>
        ...
        <fieldset v-if="individualisationMedicaments" class="fr-fieldset">
          <div class="fr-fieldset__element fr-col-12">
            <DsfrInputGroup
              ...
              @update:model-value="
                onPrecisionIndividualisationMedicamentsChange
              "
            />
          </div>
        </fieldset>
