                ...
                stack: [
                  {
                    bold: true,
                    fontSize: 12,
                    text: `ACCUSE DE RECEPTION POUR LA DECLARATION COMPLEMENTAIRE ${declaration.idFonctionnelle}`,
                  },
                ],
              },
            ],
  ...
  return new Promise((resolve) => {
    const docDefinition = {
      content: [
        ...
        {
          style: "header",
          text: `Nous accusons ce jour, le ${dayjs().format("DD/MM/YYYY")}, réception de votre déclaration complémentaire.\n\n`,
        },
      ],
      defaultStyle: {
        font: "Marianne",
