...
export type EigTypeCode = {
  [K in keyof typeof Types]: (typeof Types)[K][keyof (typeof Types)[K]];
}[keyof typeof Types];

export const mapEigToLabel: Record<EigTypeCode, string> = {
...
export const isDeclarationligibleToEig = (d: {
  dateDebut: string;
  dateFin: string;
  statut: string;
}) =>
...
export const isUserDreetsWhoDeliveredAgrement = (
  territoireCode: string,
  agrementRegionObtention: string,
) => territoireCode === agrementRegionObtention;

export const isUserDdetsWhereEigHappened = (
  territoireCode: string,
  eigDepartement: string,
) => territoireCode === eigDepartement;

export const mustMarkAsRead = (
  territoireCode: string,
  eig: {
    readByDdets: boolean;
...
export const isTypeActive = (type: string) => {
