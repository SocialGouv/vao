...
exports.up = async function (knex) {
  ...
  const activites = [
    ...
    { activite_type: "SPORT", code: "ULM", id_tech: 5, libelle: "ULM" },
    {
      activite_type: "SPORT",
      code: "EQUITATION",
      id_tech: 6,
    ...
    { activite_type: "SPORT", code: "SKI", id_tech: 7, libelle: "Ski" },
    {
      activite_type: "SPORT",
    ...
    { activite_type: "SPORT", code: "PECHE", id_tech: 9, libelle: "Pêche" },
    {
      activite_type: "SPORT",
      code: "AUTRES_SPORT",
      id_tech: 10,
    ...
    { activite_type: "CULTURE", code: "DANSE", id_tech: 16, libelle: "Danse" },
    { activite_type: "CULTURE", code: "CHANT", id_tech: 17, libelle: "Chant" },
    {
      activite_type: "CULTURE",
